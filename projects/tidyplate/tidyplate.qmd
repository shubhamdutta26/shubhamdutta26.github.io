...
#| label: image
#| echo: false
#| fig-cap: "This figure demonstrates how to format the 12-well plate input file. Colors are for visualization purposes only."
#| out-width: '100%'
knitr::include_graphics("tidy_plate.png")
```
...
library(tidyplate)
check_plate("example_12_well.xlsx")
```
...
data <- tidy_plate("example_12_well.xlsx")
head(data)
```
